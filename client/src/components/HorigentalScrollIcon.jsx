...
import {
  ...
  FaLaptopCode,
  FaBook,
} from "react-icons/fa"; // Importing diverse icons
      ...
      <ul className="scroll-container scrollbar grid grid-flow-col overflow-x-auto">
        {data.map((item) => (
          <NavLink
            ...
            to={item.link}
            key={item.id}
            className="mt-4 flex w-auto flex-col items-center justify-center border-r-[1px] border-gray-500 bg-gray-800 px-4 py-1 text-center text-lg text-white hover:bg-gray-700 hover:text-yellow-500 active:bg-green-400">
